  ...
  return (
    <div className="flex min-h-screen bg-background relative">
      ...
      <a
        ...
        className="absolute top-2 sm:top-4 left-[calc(50%+8rem)] sm:left-[calc(50%+8rem)] -translate-x-1/2 z-30 flex items-center justify-center px-2 py-1 sm:px-3 sm:py-2 rounded-xl bg-white/60 backdrop-blur-sm border border-white/40 shadow-md hover:bg-white/80 transition-colors max-w-[40vw] sm:max-w-none"
