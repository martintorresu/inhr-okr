// InHR Strategy - Mock Data for Demo Mode
...
export interface KeyResult {
  id: string;
  title: string;
  type: "numeric" | "binary" | "scale" | "manual";
  current: number;
  target: number;
  unit?: string;
  progress: number;
  ...
  },
  {
    ...
    keyResults: [
      ...
      },
      {
        ...
        initiatives: [
          { id: "ini5", title: "Optimización de queries y caché", responsible: "Diego Flores", krId: "kr5", startDate: "2026-02-15", endDate: "2026-05-30", progress: 45, status: "at_risk" as any, tasks: [{ id: "t11", title: "Auditar queries lentos", completed: true }, { id: "t12", title: "Implementar Redis cache", completed: false }] },
        ],
      },
    ],
  },
  {
    ...
    keyResults: [
      ...
      },
      {
        ...
        initiatives: [
          { id: "ini7", title: "Estrategia content marketing LATAM", responsible: "Camila Ríos", krId: "kr7", startDate: "2026-02-01", endDate: "2026-06-30", progress: 25, status: "behind" as any, tasks: [{ id: "t15", title: "Crear blog en español", completed: true }, { id: "t16", title: "Webinars mensuales", completed: false }] },
        ],
      },
    ],
  },
...
export const globalProgress = Math.round(objectives.reduce((s, o) => s + o.progress, 0) / objectives.length);
